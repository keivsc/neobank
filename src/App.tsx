...
// API & utils
import { checkDevice, registerDevice, verifyToken } from './utils/api';
...
import SendRequestPage from './pages/sendRequested';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/send/:requestId" element={<SendRequestPage/>} />
